...
export const SPECIMENS: Specimen[] = [
  ...
  },
  {
    ...
    name: "Making fire",
    khmer: null,
    english: "CH₄ + 2 O₂ → CO₂ + 2 H₂O — what burning actually is",
    subject: "chemistry",
    topic: "Experiments",
    animated: true,
    knob: { label: "Reaction speed", min: 5, max: 100, step: 5, value: 35, unit: "%" },
    layers: [
      { id: "whole", label: "Space-filling", hint: "How much room each molecule takes up" },
      { id: "cutaway", label: "Ball and stick", hint: "Which atom is joined to which" },
      { id: "frame", label: "Bonds only", hint: "Just the bonds breaking and forming" },
    ],
    about: [
      "A flame is a chemical reaction you can see. Methane meets oxygen, the old bonds break, new ones form, and the energy left over comes out as heat and light.",
      "Watch what goes in and what comes out. One carbon, four hydrogens and four oxygens before; one carbon, four hydrogens and four oxygens after. Nothing was created and nothing destroyed — the atoms were only rearranged. That is the single hardest idea in school chemistry, and counting is the way to believe it.",
      "This is also why a fire goes out under a lid: no oxygen, no reaction. And why the products are invisible — carbon dioxide and water vapour both leave as gases.",
      "Everything here is a molecular model, not a recipe. Real fire, real acid and real alkali are all dangerous, and never worth improvising with — understand them here, and do the real thing only in a school laboratory with a teacher.",
    ],
    parts: [
      { id: "carbon", name: "Carbon", khmer: null, layer: "cutaway", at: [-150, 60, 0],
        blurb: "One carbon goes in, inside the methane, and one comes out, inside the carbon dioxide. It is the same atom." },
      { id: "oxygen", name: "Oxygen", khmer: null, layer: "cutaway", at: [-150, -70, 0],
        blurb: "Two oxygen molecules — four atoms. They end up split between the carbon dioxide and the two waters." },
      { id: "hydrogen", name: "Hydrogen", khmer: null, layer: "cutaway", at: [150, -70, 0],
        blurb: "Four hydrogens start on the carbon and finish on the oxygens. That is where the water comes from." },
    ],
    quiz: [
      {
        q: "Burning methane produces…",
        options: ["Carbon dioxide and water", "Only smoke", "Nothing — it disappears", "Carbon and hydrogen"],
        answer: 0,
        why: "Both leave as invisible gases, which is why it looks like the fuel vanishes. Weigh everything, including the air, and nothing is missing.",
      },
      {
        q: "Why does a fire go out when you cover it?",
        options: ["It gets too cold", "It runs out of oxygen", "The smoke smothers it", "The fuel evaporates"],
        answer: 1,
        why: "The reaction needs oxygen from the air. Cut off the supply and it stops, however much fuel is left.",
      },
      {
        q: "In this reaction, the total number of atoms…",
        options: ["Goes up", "Goes down", "Stays exactly the same", "Depends on the temperature"],
        answer: 2,
        why: "Exactly the same, always. The atoms are rearranged into different molecules — that is what a chemical reaction is.",
      },
    ],
    sizeU: 250,
    spanU: 290,
    centreU: 0,
    reallife: "The same reaction as a gas stove, a biogas burner, and a candle — different fuel, same idea.",
  },
  {
    id: "make-water",
    name: "Making water",
    khmer: null,
    english: "2 H₂ + O₂ → 2 H₂O — building it from its elements",
    subject: "chemistry",
    topic: "Experiments",
    animated: true,
    knob: { label: "Reaction speed", min: 5, max: 100, step: 5, value: 35, unit: "%" },
    ...
    about: [
      "Two gases you cannot see, and what they make is the most ordinary substance there is. Hydrogen burns in oxygen and the only product is water.",
      "It gives out a great deal of energy — this is the reaction that lifted rockets. Which also means the reverse costs energy: splitting water back into hydrogen and oxygen needs electricity, and that is electrolysis.",
      "Notice that the products are nothing like the reactants. Two invisible gases, both of which will burn or feed a fire, become the liquid you put a fire out with. Properties belong to compounds, not to the elements in them.",
      "Everything here is a molecular model, not a recipe. Real fire, real acid and real alkali are all dangerous, and never worth improvising with — understand them here, and do the real thing only in a school laboratory with a teacher.",
    ],
    parts: [
      { id: "hydrogen", name: "Hydrogen", khmer: null, layer: "cutaway", at: [-150, 56, 0],
        blurb: "The lightest element. Two molecules — four atoms — go in, and all four end up in water." },
      { id: "oxygen", name: "Oxygen", khmer: null, layer: "cutaway", at: [-150, -76, 0],
        blurb: "One molecule, two atoms, one for each water made. Oxygen does not burn; it is what other things burn in." },
    ],
    quiz: [
      {
        q: "Hydrogen burns in oxygen. What is produced?",
        options: ["Smoke", "Carbon dioxide", "Water only", "Nothing"],
        answer: 2,
        why: "Only water. There is no carbon anywhere in the reaction, so there is nothing for carbon dioxide to be made from.",
      },
      {
        q: "Splitting water back into hydrogen and oxygen…",
        options: ["Releases energy", "Needs energy put in", "Happens on its own", "Is impossible"],
        answer: 1,
        why: "Needs energy — electricity, in electrolysis. Running a reaction backwards costs whatever the forward reaction gave out.",
      },
    ],
    sizeU: 250,
    spanU: 290,
    centreU: 0,
    reallife: "The reaction that powered the Space Shuttle's main engines, and the one a hydrogen fuel cell runs in reverse.",
  },
  {
    id: "neutralise",
    name: "Acid meets alkali",
    khmer: null,
    english: "HCl + NaOH → salt water — and why the danger cancels",
    subject: "chemistry",
    topic: "Experiments",
    animated: true,
    knob: { label: "Reaction speed", min: 5, max: 100, step: 5, value: 35, unit: "%" },
    ...
    about: [
      "A strong acid and a strong alkali are both dangerous. Put them together in the right amounts and what you are left with is salt water — that is neutralisation.",
      "The reaction is simpler than it looks. The acid's hydrogen and the alkali's hydroxide join to make water; the sodium and the chloride are left over, floating separately in it. They do not pair up into molecules — as the salt exhibit shows, there is no such thing as an NaCl molecule.",
      "It gives out heat, which is why the beaker gets warm. It is also why an antacid tablet settles indigestion, and why farmers spread lime on soil that has turned acidic.",
      "Everything here is a molecular model, not a recipe. Real fire, real acid and real alkali are all dangerous, and never worth improvising with — understand them here, and do the real thing only in a school laboratory with a teacher.",
    ],
    parts: [
      { id: "hydrogen", name: "Hydrogen from the acid", khmer: null, layer: "cutaway", at: [-150, 58, 0],
        blurb: "What makes an acid an acid is its ability to give this away. Here it goes straight onto the hydroxide and becomes part of water." },
      { id: "oxygen", name: "Hydroxide from the alkali", khmer: null, layer: "cutaway", at: [-150, -74, 0],
        blurb: "The OH group. It takes the acid's hydrogen, and the pair of them is a water molecule." },
      { id: "sodium", name: "Sodium ion", khmer: null, layer: "cutaway", at: [150, 68, 0],
        blurb: "A spectator: it starts charged and ends charged, and takes no part in the reaction itself. It is simply dissolved afterwards." },
      { id: "chloride", name: "Chloride ion", khmer: null, layer: "cutaway", at: [150, 8, 0],
        blurb: "The other spectator. Between them these two are what makes the leftover liquid salty." },
    ],
    quiz: [
      {
        q: "An acid and an alkali react to make…",
        options: ["A stronger acid", "A salt and water", "A gas only", "Nothing"],
        answer: 1,
        why: "A salt and water. Which salt depends on which acid and which alkali — here, sodium chloride: ordinary table salt.",
      },
      {
        q: "Which part of the reaction actually happens?",
        options: [
          "Sodium joins chloride",
          "Hydrogen joins hydroxide to make water",
          "Everything swaps places at once",
          "The sodium turns into water"],
        answer: 1,
        why: "Only the water forms. The sodium and chloride ions are spectators — charged before, charged after, dissolved throughout.",
      },
      {
        q: "Why does the beaker get warm?",
        options: ["Friction", "The reaction gives out energy", "The acid was already hot", "It does not"],
        answer: 1,
        why: "Neutralisation is exothermic. Forming the water bonds releases more energy than breaking the old ones took.",
      },
    ],
    sizeU: 250,
    spanU: 290,
    centreU: 0,
    reallife: "The same reaction as an antacid tablet, and as lime spread on sour soil.",
  },
  {
    id: "treadle-pump",
    name: "Treadle pump",
    khmer: null,
    english: "Water onto a dry field, powered by standing on it",
    subject: "agri",
    topic: "Irrigation",
    animated: true,
    knob: { label: "Pedalling speed", min: 10, max: 100, step: 5, value: 45, unit: "%" },
    layers: [
      { id: "whole", label: "Assembled", hint: "The pump as it stands beside a pond" },
      { id: "cutaway", label: "Cylinders", hint: "See-through, showing the pistons and valves" },
      { id: "frame", label: "Water path", hint: "Just the pipes and the valves" },
    ],
    about: [
      "Two cylinders, two pedals, and a person's weight. You walk on the spot and water comes up. No fuel, no electricity, and every part is something a village workshop can cut or weld.",
      "The two cylinders work alternately — one is always pushing while the other is filling — which is why the flow is steady rather than a series of gulps.",
      "The valves are the part worth watching. Each cylinder has one at the bottom that only opens upward, so water that has been lifted cannot fall back down. Take those away and the whole machine moves water up and down and delivers nothing at all. Almost every pump ever built is a piston and a one-way valve.",
    ],
    parts: [
      { id: "treadle", name: "Treadles", khmer: null, layer: "whole", at: [0, 60, 20],
        blurb: "The two pedals. Your weight is the power source, which is the whole point: a pump that costs nothing to run is a pump a farming family can actually keep." },
      { id: "cylinder", name: "Cylinders", khmer: null, layer: "cutaway", at: [-32, 4, 14],
        blurb: "Two of them, worked in opposition. One fills while the other delivers, so the flow never stops." },
      { id: "piston", name: "Pistons", khmer: null, layer: "cutaway", at: [30, 10, 14],
        blurb: "A disc that seals against the cylinder wall. Traditionally leather or rubber cut from an old tyre — cheap, and replaceable by anyone." },
      { id: "valve", name: "Foot valves", khmer: null, layer: "cutaway", at: [-34, -26, 14],
        blurb: "One-way valves at the bottom of each cylinder. They let water in on the up stroke and refuse to let it back out. Without them the pump does nothing." },
      { id: "pipes", name: "Suction pipe and spout", khmer: null, layer: "frame", at: [34, 34, 12],
        blurb: "Down into the water, and out to the field. A treadle pump can only suck water up about seven metres — beyond that the atmosphere is not pushing hard enough." },
    ],
    quiz: [
      {
        q: "What stops the lifted water falling back down the cylinder?",
        options: ["The piston seal", "A one-way valve at the bottom", "The suction pipe", "Nothing — some falls back"],
        answer: 1,
        why: "The foot valve. It opens upward only, so each stroke keeps what the last one lifted. It is the single component that turns movement into pumping.",
      },
      {
        q: "Why does a treadle pump have two cylinders rather than one?",
        options: [
          "To lift twice as high",
          "So one delivers while the other fills, giving a steady flow",
          "For balance only",
          "To use less water"],
        answer: 1,
        why: "Alternating them turns a series of gulps into a continuous stream — and it lets you use both legs.",
      },
    ],
    sizeU: 190,
    spanU: 190,
    centreU: 8,
    reallife: "About 1.2 m tall. Lifts water roughly 7 m, at 1 to 2 litres a second, for the cost of a day's labour to build.",
  },
  {
    id: "biogas",
    name: "Biogas digester",
    khmer: null,
    english: "Animal waste in, cooking gas and fertiliser out",
    subject: "agri",
    topic: "Energy on the farm",
    animated: true,
    knob: { label: "Waste fed per day", min: 10, max: 100, step: 5, value: 50, unit: "%" },
    layers: [
      { id: "whole", label: "From outside", hint: "What you would see in a yard" },
      { id: "cutaway", label: "Inside the pit", hint: "The slurry, the gas, and the bubbles" },
      { id: "frame", label: "Pipes", hint: "Where everything goes in and comes out" },
    ],
    about: [
      "A sealed pit behind the house. Animal dung and water go in one side; gas comes off the top and goes to the kitchen; what is left comes out the other side as fertiliser. Nothing is wasted, and thousands of Cambodian households already have one.",
      "Inside, bacteria that cannot tolerate air break the waste down. Their by-product is methane — the same molecule that has its own exhibit in this Lab — and burning it on the stove is exactly the reaction in \"Making fire\". You can follow one substance from a heap of manure to a blue flame under a pot without leaving the Lab.",
      "The slurry that comes out the far end is better fertiliser than the dung that went in, because digestion has broken it into a form plants take up faster. A machine with no moving parts that produces both fuel and fertiliser is a rare thing.",
    ],
    parts: [
      { id: "inlet", name: "Inlet", khmer: null, layer: "whole", at: [-64, 16, 16],
        blurb: "Where dung and water are mixed and poured in. The mix matters: too thick and it will not flow, too thin and the bacteria are diluted." },
      { id: "tank", name: "The digester", khmer: null, layer: "whole", at: [0, -34, 40],
        blurb: "A sealed brick or concrete dome, buried so the ground keeps it at an even temperature. The bacteria inside work best warm and die if air gets in." },
      { id: "slurry", name: "Slurry", khmer: null, layer: "cutaway", at: [-56, -40, 20],
        blurb: "Waste and water, and the bacteria doing the work. They break down what an animal's gut could not, and give off gas as they go." },
      { id: "gas", name: "Gas — mostly methane", khmer: null, layer: "cutaway", at: [0, 34, 30],
        blurb: "About 60% methane, the rest mostly carbon dioxide. It collects under the dome and the pressure pushes it up the pipe.",
        detail: "methane" },
      { id: "stove", name: "Pipe and stove", khmer: null, layer: "whole", at: [66, 62, 16],
        blurb: "The point of the whole thing: a burner in the kitchen that costs nothing to feed, and no more walking for firewood.",
        detail: "burn-methane" },
      { id: "outlet", name: "Outlet", khmer: null, layer: "whole", at: [64, 16, 16],
        blurb: "Digested slurry, which is better fertiliser than what went in. Every litre fed in comes back out — the gas is the only thing that leaves separately." },
    ],
    quiz: [
      {
        q: "What is the main gas a digester produces?",
        options: ["Oxygen", "Methane", "Hydrogen", "Nitrogen"],
        answer: 1,
        why: "About 60% methane — the same molecule as natural gas, and the same one that burns in the Making fire experiment.",
      },
      {
        q: "Why must the digester be sealed against air?",
        options: [
          "To keep the smell in",
          "The bacteria that make the gas cannot work in air",
          "To keep it warm",
          "To stop rain getting in"],
        answer: 1,
        why: "They are anaerobic — air kills them, and the digestion stops. Sealing it is not about smell, it is what makes it work at all.",
      },
      {
        q: "What comes out of the far end?",
        options: ["Nothing", "Clean water", "Fertiliser", "More gas"],
        answer: 2,
        why: "Digested slurry, which plants take up faster than raw dung. The pit produces fuel and fertiliser from the same input.",
      },
    ],
    sizeU: 175,
    spanU: 175,
    centreU: 6,
    reallife: "A household digester is about 4 m³ buried in the yard, and makes enough gas for a family's cooking.",
  },
  {
    id: "organ-brain",
    name: "Brain",
