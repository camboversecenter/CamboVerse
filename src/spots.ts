...
export const SPOTS: Spot[] = [
  {
    ...
    pois: [
      ...
      },
      {
        ...
        khmer: "គោបុរៈខាងលិច",
        info: "The long galleried gateway is the ceremonial western entrance — a towered portal in a wall stretching to the corners, the threshold between the outer world and the temple grounds.",
        target: [0, 1.6, 13.4],
        camera: [3.8, 3.0, 17.6],
      },
      {
