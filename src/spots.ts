...
export const SPOTS: Spot[] = [
  ...
  },
  {
    ...
    blurb:
      "A massive, remote 12th-century temple complex famed for its face towers and an adventurous, lost-in-the-jungle atmosphere.",
    lat: 14.071,
    lng: 103.111,
    model: "/models/heritage-sample.glb",
    live: true,
    pois: [
      {
        id: "face-towers",
        title: "Massive Face Towers",
        info: "Similar to Bayon, featuring the enigmatic faces of Lokeshvara.",
        target: [0, 1.5, -2],
        camera: [3, 2, 5],
      },
      {
        id: "satellite-temples",
        title: "Satellite Temples",
        info: "Nine unrestored secondary temples scattered in the surrounding forest.",
        target: [0, 1.0, -1],
        camera: [4, 1.5, 4],
      },
    ],
  },
  {
    ...
    province: "Siem Reap",
    blurb:
      "A sprawling 12th-century complex built by King Jayavarman VII that once functioned as a Buddhist university and city.",
    lat: 13.461,
    lng: 103.871,
    model: "/models/heritage-sample.glb",
    live: true,
    ...
    pois: [
      {
        id: "labyrinthine-galleries",
        title: "Labyrinthine Galleries",
        info: "A maze of successive rectangular galleries, connecting corridors, and courtyards.",
        target: [0, 1.5, -2],
        camera: [3, 2, 5],
      },
      {
        id: "hall-of-dancers",
        title: "Hall of Dancers",
        info: "One of the most notable ceremonial spaces, adorned with carvings of celestial Apsara dancers.",
        target: [0, 1.0, -1],
        camera: [4, 1.5, 4],
      },
    ],
  },
  {
    ...
    province: "Siem Reap",
    blurb:
      "The quintessential Jungle Temple, where nature has extensively reclaimed the 12th-century sandstone structures.",
    lat: 13.475,
    lng: 104.225,
    model: "/models/heritage-sample.glb",
    live: true,
    pois: [
      {
        ...
        info: "Massive stone blocks scattered in heaps, with tree roots weaving through collapsed galleries, towers, and walls.",
        target: [0, 1.5, -2],
        camera: [3, 2, 5],
      },
    ],
  },
  {
    ...
    province: "Siem Reap",
    blurb:
      "A sacred mountain and the birthplace of the Khmer Empire, blending natural wonders with ancient spiritual landmarks.",
    lat: 13.566,
    lng: 104.116,
    nudge: [0.6, -1.0],
    model: "/models/heritage-sample.glb",
    ...
    pois: [
      {
        ...
        info: "A dramatic two-tier waterfall, excellent for swimming and picnicking.",
        target: [0, 1.5, -2],
        camera: [3, 2, 5],
      },
      {
        id: "river-of-lingas",
        title: "River of a Thousand Lingas",
        info: "A sacred riverbed featuring thousands of lingas etched directly into the stone underwater.",
        target: [0, 1.0, -1],
        camera: [4, 1.5, 4],
      },
    ],
  },
  {
    ...
    blurb:
      "The former royal capital of Cambodia, known for its sacred hill crowned with historic stupas housing the ashes of former Khmer kings.",
    lat: 11.815,
    lng: 104.743,
    model: "/models/heritage-sample.glb",
    live: true,
    pois: [
      {
        ...
        info: "The 'Mountain of the Royal Treasures', accessed by a climb of over 500 steps, offering scenic views.",
        target: [0, 1.5, -2],
        camera: [3, 2, 5],
      },
      {
        id: "royal-stupas",
        title: "Royal Stupas",
        info: "Various stupas on the hill containing the remains of kings, each featuring distinct architectural styles and carvings.",
        target: [0, 1.0, -1],
        camera: [4, 1.5, 4],
      },
    ],
