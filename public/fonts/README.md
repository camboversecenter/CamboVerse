...
|---|---|---|---|---|
| **Siemreap** | `Siemreap-Khmer.woff2` | the **normal** Khmer letter shapes | OFL-1.1 (`Siemreap-OFL.txt`) | google/fonts · Danh Hong |
...
- Siemreap — © 2010 Danh Hong (khmertype.blogspot.com).
